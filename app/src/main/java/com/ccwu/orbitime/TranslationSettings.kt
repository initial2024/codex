...
/** Local translation preferences. Context translation is opt-in, persistent and Pro-gated. */
object TranslationSettings {
    ...
    fun isContextTranslationAvailable(context: Context): Boolean = ProGate.isContextTranslationUnlocked(context)
